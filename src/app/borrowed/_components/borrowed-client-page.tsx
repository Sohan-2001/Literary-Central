...
import { borrowedColumns } from "./borrowed-columns";
import { Card, CardContent, CardHeader } from "@/components/ui/card";

interface BorrowedClientPageProps {
  borrowedBooks: PopulatedBorrowedRecord[];
}

export function BorrowedClientPage({ borrowedBooks }: BorrowedClientPageProps) {
